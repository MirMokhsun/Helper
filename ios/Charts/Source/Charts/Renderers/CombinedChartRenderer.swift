    ...
    internal func createRenderers()
    {
        ...
        for order in drawOrder
        {
            ...
            case .line:
                ...
                {
                    _renderers.append(LineChartRenderer(dataProvider: chart, animator: animator, viewPortHandler: viewPortHandler, predictionMarkup: chart.predictionMarkup as? PredictionMarkup ))
                }
                break
